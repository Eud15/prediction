    ...
    <div class="relative">
        ...
        <div class="fixed bottom-6 ltr:right-6 rtl:left-6 z-50">
            <template v-if="showTopButton">
                <button
                    type="button"
                    class="btn btn-outline-warning rounded-full p-2 animate-pulse bg-[#fafafa] dark:bg-[#060818] dark:hover:bg-primary"
                    @click="goToTop"
                >
        ...
        <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[store.navbar]">
            ...
            <div class="main-content flex flex-col min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
                <!--  BEGIN TOP NAVBAR  -->
                <Header />
                <!--  END TOP NAVBAR  -->
