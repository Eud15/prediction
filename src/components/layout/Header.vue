<template>
    <header class="z-40" :class="{ dark: store.semidark && store.menu === 'horizontal' }">
        <div class="shadow-sm">
            <div class="relative bg-white flex w-full items-center px-5 py-5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        <!-- <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="../../../../public/assets/images/mtnLogo.png" alt="" /> -->
                        <span
                    ...
                    <a
                        href="javascript:;"
                        class="collapse-icon flex-none dark:text-[#d0d2d6] hover:text-black dark:hover:text-black flex lg:hidden ltr:ml-2 rtl:mr-2 p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
                    ...
                    <div class="sm:ltr:mr-auto sm:rtl:ml-auto">
                        ...
                        >
                            <div class="relative">
                                <input
                                    type="text"
                                    class="form-input text-xs ltr:pl-9 rounded-lg rtl:pr-9 ltr:sm:pr-4 rtl:sm:pl-4 ltr:pr-9 rtl:pl-9 peer sm:bg-transparent bg-gray-100 placeholder:tracking-widest"
                                    placeholder="Rechercher..."
                                />
                                <button type="button" class="absolute w-9 h-9 inset-0 ltr:right-auto rtl:left-auto appearance-none peer-focus:text-warning">
                                    ...
                                    <template v-if="messages.length">
                                        <li class="border-t border-white-light text-center dark:border-white/10 mt-5">
                                            <div
                                                ...
                                                @click="close()"
                                            >
                                                <span class="group-hover:underline ltr:mr-1 rtl:ml-1">Voir toutes les activités</span>
                            ...
                            <template #content="{ close }">
                                <ul class="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    ...
                                    <template v-if="notifications.length">
                                        <li>
                                            <div class="p-4">
                                                <button class="btn btn-primary block w-full btn-small" @click="close()">Lire toutes les Notifications</button>
                                            </div>
                                        </li>
                                    </template>
                                    <template v-if="!notifications.length">
                        ...
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8" class="!block">
                            ...
                            <template #content="{ close }">
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            ...
                                            <div class="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 class="text-base">
                                                    John Doe<span class="text-xs bg-success-light rounded text-success text-xs px-1 ltr:ml-2 rtl:ml-2">Admin</span>
                                                </h4>
                                                <a class="text-black/60 text-xs hover:text-warning dark:text-dark-light/60 dark:hover:text-white" href="javascript:;"
                                                    >johndoe@gmail.com</a
                                                >
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <router-link to="/user/reset-password" class="dark:hover:text-white" @click="close()">
                                            <icon-user class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
    ...
    const notifications = ref([
        {
            ...
            message: '<strong class="text-sm mr-1">John Doe</strong>vient de lancer une requête de modification du profil ',
            time: '45 min ',
        },
        {
            id: 2,
            profile: 'profile-34.jpeg',
            message: '<strong class="text-sm mr-1">Agba Yarn</strong>vient d\'effectuer une requête de commande',
            time: '9h ',
        },
    ...
    const messages = ref([
        {
            ...
            title: 'Requête réussit!',
            message: 'Une requête vient d\'être effectué avec succès',
            time: '1hr',
        },
        {
            id: 2,
            ...
            message: 'Un utilisateur vient de modifier son profile.',
            time: '2hr',
        },
        {
            id: 3,
            image: '<span class="grid place-content-center w-9 h-9 rounded-full bg-danger-light dark:bg-danger text-danger dark:text-danger-light"> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span>',
            title: 'Suppression de requêtes!',
            message: 'Un utilisateur vient de supprimer une requête',
            time: '2days',
        },
        {
            id: 4,
            ...
            title: 'Attention',
            message: 'Cinq opérations en attente d\'activation.',
            time: '5days',
        },
    ]);
